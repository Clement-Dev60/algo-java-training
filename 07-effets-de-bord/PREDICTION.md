...
**Question : `nombre` dans main a-t-il changé ?** Non car la fonction est juste executée comme ça, on n'appelle pas "nombre = modifierNombre(nombre)"
...
Réponse : Parce qu’en Java, les types primitifs sont passés par valeur (copie), modifier n ne modifie pas nombre

Les tableaux sont passés par copie de référence
les deux variables pointent vers le même tableau, donc toute modification interne est visible dans main
